(function(window, angular) {
  ...
  function injectSDK($q, $interval) {
    ...
    script.onload = function() {
      ...
      waitForReady = $interval(function() {
        if (flags.ready) {
          $interval.cancel(waitForReady);
          deferred.resolve();
        }
      }, 100);
    };
  ...
  angular.module('facebook', []).
    ...
    provider('Facebook', [
      function() {
        ...
        this.$get = [
          ...
          '$interval',
          '$window',
          function($q, $rootScope, $timeout, $interval, $window) {
            /**
            ...
            NgFacebook.prototype.injectedSDK = function() {
              return flags.injected;
            };

            NgFacebook.prototype.injectSDK = function() {
              return injectSDK($q, $interval);
            };
    ...
    run([
      ...
      '$timeout',
      '$interval',
      function($rootScope, $q, $window, $timeout, $interval) {
